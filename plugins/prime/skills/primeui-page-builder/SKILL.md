...
1. Confirm `.primeui/project.json` exists at the exported project root.
...
5. Stop before planning or editing if readiness fails. Ask the user to connect the project, rerun PrimeUI AI setup, pass the correct `projectRoot`, or fix the API base/key.
